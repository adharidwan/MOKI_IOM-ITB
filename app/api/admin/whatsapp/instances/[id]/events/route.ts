...
import { handleGetWhatsappInstanceEventsRequest } from '../../../../../../lib/whatsapp-ops-service';
...
export async function GET(request: Request, { params }: Props): Promise<Response> {
  try {
    ...
    return handleGetWhatsappInstanceEventsRequest(resolvedParams.id, createWhatsappOpsRepository());
  } catch (error) {
